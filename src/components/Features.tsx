      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Poliara learns from context, continuously refining queries and insights to deliver more accurate analytics."
            index={0}
          />
          <FeatureCard
            ...
            description="Ask questions in plain English. Poliara understands context and converts queries into optimized SQL or API requests."
            index={1}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 7h10v10H7z"/><path d="M7 3v4"/><path d="M17 3v4"/><path d="M3 7h18"/></svg>}
            title="Visual Analytics"
            description="Automatic generation of charts, tables, and dashboards from your data queries."
            index={2}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7"/><ellipse cx="12" cy="7" rx="8" ry="4"/></svg>}
            title="Data Warehouse Integration"
            description="Direct integration with BigQuery, Snowflake, and major data warehouses for real-time analytics."
            index={3}
          />
          <FeatureCard
            ...
            description="Role-based access control and encryption ensure your data remains secure and compliant."
            index={4}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>}
            title="Complex Analytics"
            description="From simple metrics to complex multi-dimensional analysis, Poliara handles a wide range of data queries."
            index={5}
          />
        </div>
      </div>
