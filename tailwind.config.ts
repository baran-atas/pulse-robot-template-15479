...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'hero-gradient': 'linear-gradient(90deg, hsla(217, 91%, 60%, 1) 0%, hsla(224, 76%, 48%, 1) 100%)',
				'hero-gradient-2': 'linear-gradient(90deg, hsla(213, 94%, 68%, 1) 0%, hsla(217, 91%, 60%, 1) 100%)',
